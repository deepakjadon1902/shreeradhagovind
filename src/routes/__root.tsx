...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Vrindavan — Sacred Products from the Holy Land" },
      ...
      { property: "og:title", content: "Vrindavan — Sacred Products from the Holy Land" },
      { name: "twitter:title", content: "Vrindavan — Sacred Products from the Holy Land" },
      ...
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/6956ef2a-eb27-4b7d-b94f-788cdf1679f5/id-preview-3259e54b--536bf53e-a31a-477b-9263-87e06697d3a4.lovable.app-1780401272362.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/6956ef2a-eb27-4b7d-b94f-788cdf1679f5/id-preview-3259e54b--536bf53e-a31a-477b-9263-87e06697d3a4.lovable.app-1780401272362.png" },
