...
export const PRODUCTS: Product[] = [
  {
    ...
    image: img("poshak"),
    description:
      "Handcrafted silk poshak for Laddu Gopal & Radha Rani, stitched by Vrindavan artisans with zari embroidery.",
  ...
  },
  {
    ...
    image: img("itra"),
    description:
      "Alcohol-free Mogra attar distilled in Kannauj, the favoured fragrance of Sri Radha.",
  ...
  },
  {
    ...
    image: img("murti"),
    description:
      "Solid brass Laddu Gopal idol with intricate detailing, polished to mirror finish.",
  ...
  },
  {
    ...
    image: img("book"),
    description:
      "Sacred Bhagavad Gita with original Sanskrit shlokas and detailed Hindi translation.",
